...
<body>
                  ...
                  <div class="container">
                     <div class="row">
                        <div class="col-md-6">
                           ...
                           <p class="banner_text">Cuidamos de ti, porque tu salud es nuestra prioridad</p>
                           <div class="btn_main">
   ...
   <div class="health_section layout_padding">
      <div class="container">
         <h1 class="health_taital">Lo mejor del cuidado de la salud para ti</h1>
         <p class="health_text">"En 'Lo mejor del cuidado de la salud para ti', nuestro compromiso es brindarte atención de calidad y bienestar en cada paso de tu camino."</p>
         <div class="health_section layout_padding">
            <div class="row">
               <div class="col-sm-7">
